...
Standing outside on the bench near your neighborhood just after midnight, having missed pre-alpha day,
...
| **MIMI** | The memory, named for his grandmother. Micro-hops the memory category unprompted | PARTIAL/contested — see `CONTRADICTIONS.md` B-3 |
