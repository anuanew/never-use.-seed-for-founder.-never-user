...
On Sunday night, August 16, walking outside with your kids and then putting them to bed, you recorded
...
```
   ...
   ┌───────────────────────────────────────────────────────────────────────────┐
   │  TEMPORARY CODERS — world builders, outside, "Brandon doesn't own them"    │
...
Named in pt 1: Eric, BJ, Christopher Thompson, MJ, Danielle, and *"we might be able to argue Raquel
